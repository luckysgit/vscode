To pivot to a pure software and data-driven counter-terrorism platform, physical edge components are completely decommissioned, while the core natural language, graph intelligence, and agentic workflows are retained and expanded.
